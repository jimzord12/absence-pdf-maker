...
2. **Read Task Definitions**: Read individual task files from `docs/tasks/{active,backlog}/<taskId>.md` to understand each task's description, acceptance criteria, and files involved
