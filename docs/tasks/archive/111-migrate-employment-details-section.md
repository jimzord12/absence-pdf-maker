# 111-migrate-employment-details-section

**Priority:** medium
**Blocks:** 118-update-persistence-service-messages, 119-update-pdf-service-messages, 123-update-component-tests-for-translations
**Blocked By:** none
**Issue:** N/A
