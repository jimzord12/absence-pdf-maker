# task-121-refactor-pdf-component-for-bilingual

**Priority:** high
**Blocks:** task-122-integrate-pdf-language-in-generation, task-125-test-pdf-bilingual-generation
**Blocked By:** task-104-create-translation-files, task-119-update-pdf-service-messages
**Issue:** N/A
...
Refactor LeaveRequestPdf.tsx to support bilingual PDF generation based on pdfLanguage prop.
